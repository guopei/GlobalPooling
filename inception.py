...
class Inception3(nn.Module):
    ...
    def __init__(self, num_classes=1000, aux_logits=False, transform_input=False, pool_name="GAP", param=1):
...
class InceptionAux(nn.Module):
    ...
    def __init__(self, in_channels, num_classes):
        ...
        self.fc_ = nn.Linear(768, num_classes)
        self.fc_.stddev = 0.001
